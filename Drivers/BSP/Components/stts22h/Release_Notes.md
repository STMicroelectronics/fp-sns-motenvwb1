...
<label for="collapse-section7" aria-hidden="true">V1.4.0 / 31-October-2022</label>
<div>
...
<label for="collapse-section6" aria-hidden="true">V1.3.0 / 23-March-2022</label>
<div>
...
<label for="collapse-section5" aria-hidden="true">V1.2.1 / 21-April-2021</label>
<div>
...
<label for="collapse-section4" aria-hidden="true">V1.2.0 / 03-March-2021</label>
<div>
...
<label for="collapse-section3" aria-hidden="true">V1.1.1 / 05-May-2020</label>
<div>
...
- Fix bug in STTS22H_TEMP_GetTemperatureLimitStatus
...
<label for="collapse-section2" aria-hidden="true">V1.1.0 / 13-January-2020</label>
<div>
...
- Update PID
- Fix issue on temperature limits
