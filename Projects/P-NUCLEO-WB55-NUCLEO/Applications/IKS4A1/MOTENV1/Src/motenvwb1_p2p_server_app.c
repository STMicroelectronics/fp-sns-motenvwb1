...
/**
  ******************************************************************************
  * @file    motenvwb1_p2p_server_app.c
...
void P2PS_STM_App_Notification(P2PS_STM_App_Notification_evt_t *pNotification)
{
  ...
  switch (pNotification->P2P_Evt_Opcode)
  {
    ...
    case P2PS_STM_WRITE_EVT:
      ...
      if (pNotification->DataTransfered.pPayload[0] ==
          0x00) /* ALL Deviceselected - may be necessary as LB Routeur informs all connection */
      {
...
#if (P2P_SERVER1 != 0)
      if (pNotification->DataTransfered.pPayload[0] ==
          0x01) /* end device 1 selected - may be necessary as LB Routeur informs all connection */
      {
        if (pNotification->DataTransfered.pPayload[1] == 0x01)
        {
          BSP_LED_On(LED_BLUE);
...
#if (P2P_SERVER3 != 0)
      if (pNotification->DataTransfered.pPayload[0] ==
          0x03) /* end device 3 selected - may be necessary as LB Routeur informs all connection */
      {
        if (pNotification->DataTransfered.pPayload[1] == 0x01)
        {
          BSP_LED_On(LED_BLUE);
...
#if (P2P_SERVER5 != 0)
      if (pNotification->DataTransfered.pPayload[0] ==
          0x05) /* end device 5 selected - may be necessary as LB Routeur informs all connection */
      {
        if (pNotification->DataTransfered.pPayload[1] == 0x01)
        {
          BSP_LED_On(LED_BLUE);
