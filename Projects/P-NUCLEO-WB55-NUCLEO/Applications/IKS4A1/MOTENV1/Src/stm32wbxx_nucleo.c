...
static GPIO_TypeDef*  LED_PORT[LEDn] = {LED_BLUE_GPIO_PORT,LED_GREEN_GPIO_PORT,};
static const uint16_t LED_PIN[LEDn]  = {LED_BLUE_PIN,LED_GREEN_PIN,};
...
{
  static const BSP_LED_GPIO_Init LedGpioInit[LEDn] = {LED_USER__BLUE_GPIO_Init,LED_USER__GREEN_GPIO_Init,};
  LedGpioInit[Led]();
