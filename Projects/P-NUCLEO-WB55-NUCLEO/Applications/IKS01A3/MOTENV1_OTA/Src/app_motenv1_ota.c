...
void MX_MOTENV1_OTA_Init(void)
{
  /* USER CODE BEGIN SV */

  /* USER CODE END SV */

  /* Initialize MOTENV1_OTA application */
  User_Init();
 ...
 */
void MX_MOTENV1_OTA_Process(void)
{

  /* Process of the MOTENV1_OTA application */
  MX_APPE_Process();
...
static void Sensors_Init(void)
{
  ...
  if(ENV_SENSOR_Init(HUM_AND_TEMP_INSTANCE, ENV_TEMPERATURE | ENV_HUMIDITY) == BSP_ERROR_NONE)
  {
